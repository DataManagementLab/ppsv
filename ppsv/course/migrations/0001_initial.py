    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_start', models.DateTimeField(default=course.models.Term.get_active_term_registration_start, verbose_name='registration Start')),
                ('registration_deadline', models.DateTimeField(default=course.models.Term.get_active_term_registration_deadline, verbose_name='registration Deadline')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(verbose_name='description')),
                ('file', models.FileField(blank=True, upload_to=course.models.course_directory_path, verbose_name='file')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='course.group', verbose_name='group')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='course.student', verbose_name='student')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='group',
            name='term',
            field=models.ForeignKey(default=course.models.Term.get_active_term, on_delete=django.db.models.deletion.CASCADE, to='course.term', verbose_name='term'),
        ),
        migrations.AddField(
            model_name='course',
            name='term',
            field=models.ForeignKey(default=course.models.Term.get_active_term, on_delete=django.db.models.deletion.CASCADE, to='course.term'),
        ),
        migrations.AddField(
            model_name='course',
            name='type',
